...
/*
    ...
    Bind slot and C-struct for uniform block 'VP':

        VP_t VP = {
            .vp = ...;
        };
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_VP, &SG_RANGE(VP));
...
/*
    ...
    void main()
    {
        gl_Position = mat4(VP[0], VP[1], VP[2], VP[3]) * vec4(position, 1.0);
    }
    
*/
static const char vs_source_glsl330[166] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x56,0x50,0x5b,0x34,0x5d,
    ...
    0x50,0x5b,0x30,0x5d,0x2c,0x20,0x56,0x50,0x5b,0x31,0x5d,0x2c,0x20,0x56,0x50,0x5b,
    0x32,0x5d,0x2c,0x20,0x56,0x50,0x5b,0x33,0x5d,0x29,0x20,0x2a,0x20,0x76,0x65,0x63,
...
static inline const sg_shader_desc* debug_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.vs.uniform_blocks[0].uniforms[0].name = "VP";
